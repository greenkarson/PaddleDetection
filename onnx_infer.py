...
def predict():
    ...
    # model_file = 'ppyoloe_crn_s_400e_coco_new.onnx'
    model_file = 'ppyoloe_plus_crn_t_auxhead_relu_300e_coco.onnx'
    model_file = 'ppyoloe_plus_crn_t_auxhead_relu_300e_coco.pdparams.onnx'
    # model_file = 'ppyoloe_crn_s_36e_pphuman.onnx'
    # model_file = 'ppyoloe_s_36e_ppvehicle.onnx'
    # model_file = 'picodet_l_640_coco_lcnet.pdparams.onnx'
    # model_file = 'picodet_s_320_lcnet_pedestrian.onnx'
    # NUM_CLASSES = 1
    NUM_CLASSES = 80
    ...
    for i in range(1):
        ...
        # cv2.imwrite('picodet_human_infer.jpg', img)
